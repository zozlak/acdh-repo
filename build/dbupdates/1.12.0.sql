...
CREATE TEMPORARY TABLE _ids AS SELECT * FROM identifiers;
CREATE TEMPORARY TABLE _rel AS SELECT * FROM relations;
CREATE TEMPORARY TABLE _met AS SELECT * FROM metadata;
CREATE TEMPORARY TABLE _mhi AS SELECT * FROM metadata_history;
CREATE TEMPORARY TABLE _fts AS SELECT * FROM full_text_search WHERE id IS NOT NULL;

DROP TABLE metadata_history;
DROP TABLE full_text_search;
DROP TABLE metadata CASCADE;
DROP TABLE relations;
DROP TABLE identifiers;
DROP TABLE resources;
DROP FUNCTION copy_identifiers;
DROP FUNCTION copy_metadata;
DROP FUNCTION copy_relations;
DROP FUNCTION fts_insert;
DROP FUNCTION fts_update;
DROP FUNCTION truncate_fts;
...
INSERT INTO resources        SELECT * from _res;
INSERT INTO identifiers      SELECT * FROM _ids;
INSERT INTO relations        SELECT * FROM _rel;
INSERT INTO metadata         SELECT * FROM _met;
INSERT INTO metadata_history SELECT * FROM _mhi;
INSERT INTO full_text_search SELECT * FROM _fts;
select id is not null, count(*) from full_text_search group by 1;
